...
private:
  ...
  QStringList added_files;
	...
	************************************/
	...
	void write_test_case(int);
	void write_interface(int);

	/****************************************************
	** Writes transport stream data to database.
	** @param int - Foreign key.
	** @param TransportDetails& - Transport Stream data.
	*****************************************************/
	void write_transport(int, TransportDetails &);

	/*******************************************************
	** Writes additional Transport stream data to database.
	** @param int - foreign key.
	** @parma TransData& - Additional transport data.
	*******************************************************/
	void write_TS_data(int, TransData&);
