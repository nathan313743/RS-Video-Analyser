...
**
** Created: Fri Jul 6 20:10:47 2012
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../tableEditor/InterfaceTab.h"
...
void InterfaceTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        InterfaceTab *_t = static_cast<InterfaceTab *>(_o);
        switch (_id) {
        case 0: _t->on_delete(); break;
        case 1: _t->on_add(); break;
        case 2: _t->on_recevied_index((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData InterfaceTab::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject InterfaceTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InterfaceTab,
      qt_meta_data_InterfaceTab, &staticMetaObjectExtraData }
};
